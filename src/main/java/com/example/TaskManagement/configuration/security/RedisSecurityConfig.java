...
import com.example.TaskManagement.configuration.redis.RedisConfig;
...
@Configuration
@EnableRedisRepositories(keyspaceConfiguration = RedisSecurityConfig.RefreshTokenKeyspaceConfig.class,
